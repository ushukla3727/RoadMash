...
public class HR_GameOverPanel : MonoBehaviour {
	...
	public IEnumerator DisplayResults(HR_PlayerHandler player){
		...
		PlayerPrefs.SetInt("Currency", PlayerPrefs.GetInt("Currency") + Mathf.FloorToInt(Mathf.Floor(player.distance * totalDistanceMoneyMP) + (player.nearMisses * totalNearMissMoneyMP) + Mathf.Floor(player.highSpeedTotal * totalOverspeedMoneyMP)));
		///Debug.Log(PlayerPrefs.GetInt("Currency") + Mathf.FloorToInt(Mathf.Floor(player.distance * totalDistanceMoneyMP) + (player.nearMisses * totalNearMissMoneyMP) + Mathf.Floor(player.highSpeedTotal * totalOverspeedMoneyMP)));
